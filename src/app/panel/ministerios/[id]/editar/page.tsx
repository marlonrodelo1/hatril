...
export default async function EditarMinisterioPage({
  ...
  return (
    <>
      <CabeceraPanel
        titulo="Editar el ministerio"
        volver={{
          href: `/panel/ministerios/${ministerio.id}`,
          texto: ministerio.nombre,
        }}
      />

      {/* `gap-8` y no el de por defecto: lo de abajo cierra el ministerio, y no
          debe leerse como una sección más del formulario. */}
